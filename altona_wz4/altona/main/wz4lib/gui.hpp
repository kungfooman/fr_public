...
class MainWindow : public sWireClientWindow { public:
...
class WinPageList : public sSingleTreeWindow<wPage> { public:
...
class WinTreeView : public sMultiTreeWindow<wTreeOp> { public:
	sBool HasBlink;
	sBool BlinkToggle;
	sArray<wTreeOp *> *Tree;
	wPage *Page;
...
class WinPara : public sWireGridFrame { public:
...
class WinStoreBrowser : public sSingleTreeWindow<StoreBrowserItem> { public:
	sMessage OpMsg;
	wDocName StoreName;
...
class WinOpList : public sSingleListWindow<wOp> { public:
	sArray<wOp *> Ops;
	sWindow *Header;
...
class WinTimeline : public sWireClientWindow { public:
	sInt Height;
	sInt DragLoop0;
	sInt DragLoop1;
	sInt Start;
...
class WinCustom : public sWindow { public:
