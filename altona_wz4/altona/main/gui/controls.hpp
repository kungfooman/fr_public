...
class sControl : public sWindow { public:
	sInt Style;
	sU32 BackColor;
	sMessage DoneMsg;
	sMessage ChangeMsg;
...
class sButtonControl : public sControl { public:
	sInt Pressed; 
...
class sFileDialogControl : public sButtonControl { public:
	sStringDesc String;
	const sChar *Text;
...
class sChoiceControl : public sControl { public:
	struct ChoiceInfo {
...
class sStringControl : public sControl { public:
...
class sValueControl : public sStringControl { public:
  sString<64> String;
  Type *ColorPtr;
  Type *Value;
  Type Min;
...
class sFlagControl : public sControl { public:
	sBool Toggle;
	sInt *Val;
	sInt Max;
	sInt Mask;
...
class sProgressBarControl : public sControl { public:
  sF32 Percentage;
...
class sBitmaskControl : public sControl { public:
  sInt X[9];
  sU8 *Val;
